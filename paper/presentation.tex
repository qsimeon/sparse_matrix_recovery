...
\begin{center}
  ...
  {\small\color{medgray} Massachusetts Institute of Technology
    \quad$\cdot$\quad \texttt{qsimeon@mit.edu}}\\[6pt]
  {\small\color{accentblue}\url{github.com/qsimeon/sparse_matrix_recovery}}\\[6pt]
...
\begin{center}
  ...
  \begin{tabular}{rl}
    {\color{accentblue}\textbf{Paper \& Code}} &
      \url{github.com/qsimeon/sparse_matrix_recovery} \\
