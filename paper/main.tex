...
Zeroing the diagonal removes this artifact and is the single most impactful step in the pipeline: in ablation experiments (E4, Section~\ref{sec:granger}), it accounts for the majority of the improvement over the chance baseline.
