...
Our headline finding is counterintuitive: a linear estimator that ignores the network's nonlinearity \emph{outperforms} an oracle estimator that knows it, because the oracle's compressed covariance is worse-conditioned---a concrete biological instance of James--Stein shrinkage.
